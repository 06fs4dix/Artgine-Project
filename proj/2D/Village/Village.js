...
import { CBlackboardModal, CMDViewer, CModalBackGround, CModalFrameView } from "../../../Artgine/artgine/util/CModalUtil.js";
...
import { CLoaderOption } from "../../../Artgine/artgine/util/CLoader.js";
{
    ...
    if (backVoxel) {
        ...
        ltree.mColliderBound = new CBound();
        ltree.mColliderBound.SetType(CBound.eType.Box);
        ...
        mtree.mColliderBound = new CBound();
        mtree.mColliderBound.SetType(CBound.eType.Box);
...
srp.mShaderAttr.push(new CShaderAttr("BlendColor2", new CVec4(SDF.eBlend.LinearDodge, 0, 1, 1)));
function AM7() {
